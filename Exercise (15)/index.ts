...
let Guest_List : string[] =['Oppenhiemer' , 'Andrew Tate' , 'Mr.Beast' , 'David Goggins']

let guest_that_didnt_come : string='Oppenhiemer'
...
let indexof_guestthatdidntcome :number= Guest_List.indexOf(guest_that_didnt_come)
